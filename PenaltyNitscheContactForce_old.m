function [Fc,pn_trial,maxPenetration] = PenaltyNitscheContactForce_old(ContactBody,TargetBody,approach)
    ...
    for i = 1:numberOfPoints 
        ...
        if penetration == 0 % we want to have at least small penetration
           continue
        end 
